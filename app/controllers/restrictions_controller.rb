class RestrictionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @restriction.save
        ...
        format.json { render action: 'show', status: :created, location: @restriction }
      else
  ...
  private
    ...
    def restriction_params
      params.require(:restriction).permit(:no_red_meat, :ovo_lacto_vegetarian, :vegetarian, :vegan, :glutein_free, :lactose_free)
    end
end
